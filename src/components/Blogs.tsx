...
const Blogs: React.FC = () => {
  ...
  return (
    <div className='relative overflow-x-hidden'>
      {/* Background layers */}
      <div className='fixed inset-0 -z-20 bg-gradient-to-br from-green-900/100 via-green-800 to-green-800/100' />
      <div className='fixed inset-0 -z-20 backdrop-blur-[2px]' />

      {/* Animated floating elements - now properly constrained */}
      <div className='fixed top-1/4 left-0 w-64 h-64 -translate-x-1/2 rounded-full bg-green-400/10 blur-xl animate-float -z-10' />
      <div className='fixed bottom-1/3 right-0 w-72 h-72 translate-x-1/2 rounded-full bg-green-600/10 blur-xl animate-float-delay -z-10' />

      {/* Content */}
      <div className='relative min-h-screen'>
        <div className='relative py-24 sm:py-32 pb-40'>
